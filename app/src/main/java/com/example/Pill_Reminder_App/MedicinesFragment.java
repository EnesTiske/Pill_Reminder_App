...
public class MedicinesFragment extends Fragment {
    ...
    private void loadMedicines() {
        ...
        medicineRepository.getByUserEmail(userId,
            medicines -> displayMedicines(medicines),
            e -> {
                Toast.makeText(requireContext(), "İlaçlar yüklenirken bir hata oluştu: ", Toast.LENGTH_SHORT).show();
                showEmptyList();
            });
    }
